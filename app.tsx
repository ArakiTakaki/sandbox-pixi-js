...
// const bunnyImage = require('./src/assets/bunny.png');
// const carrotImage = require('./src/assets/carrot.png')
...
// var texture = PIXI.Texture.fromImage(bunnyImage);
// var carrotTex = PIXI.Texture.fromImage(carrotImage);
